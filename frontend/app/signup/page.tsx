        ...
        <div className="mx-auto grid max-w-5xl gap-6 px-4 pb-12 pt-12 sm:gap-10 sm:pt-16 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <FadeIn delay={0.2} className="w-full max-w-sm justify-self-center lg:justify-self-end">
            <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)]/60 p-5 shadow-lg backdrop-blur-sm sm:p-6">
              <h2 className="mb-5 text-center text-lg font-semibold">Create account</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                <div>
                  <label htmlFor="name" className="mb-1.5 block text-xs font-medium text-[var(--muted-foreground)]">
                    Full name
                  </label>
                  <input
                    id="name"
                ...
                <div>
                  <label htmlFor="confirm" className="mb-1.5 block text-xs font-medium text-[var(--muted-foreground)]">
                    Confirm password
                  </label>
                  <input
                    id="confirm"
                  ...
                  />
                  {confirm && !passwordsMatch && (
                    <p className="mt-1 text-xs text-pawa-error">Passwords don&apos;t match</p>
                  )}
                </div>
              ...
              <p className="mt-5 text-center text-sm text-[var(--muted-foreground)]">
                ...
                <Link href="/login" className="font-medium text-pawa-cyan hover:underline">
                  Log in
                </Link>
              </p>
            </div>
